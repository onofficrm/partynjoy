...
export const StoryView: React.FC<StoryViewProps> = ({
  ...
  const categories = ['전체', '경험담', '직장인', '개인사업자', '주부', '청년/프리랜서'];
              ...
              {relatedStories.map((rel) => (
                ...
                >
                  <div className="flex items-center justify-between text-[11px]">
                    ...
                    <span className="font-bold text-[#2B8A3E]">{rel.reliefRate > 0 ? rel.reliefRate + '% 탕감' : '경험담'}</span>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-3">
                    ...
                    <span className="text-xs font-extrabold px-2.5 py-0.5 bg-[#EBFBEE] text-[#2B8A3E] rounded-md flex items-center gap-1">
                      ...
                      <span>{story.reliefRate > 0 ? story.reliefRate + '% 탕감' : '경험담'}</span>
                    </span>
                  </div>
